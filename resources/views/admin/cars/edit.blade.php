...
{{--                @csrf @method('PUT')--}}
{{--                --}}{{-- Fields same as create, but with old or existing values --}}
{{--                <div>--}}
...
{{--                </div>--}}
{{--                --}}{{-- repeat for brand, model, year, car_type, daily_rent_price, availability --}}
{{--                <div>--}}
{{--                    <label class="block font-medium">Image</label>--}}
{{--                    @if($car->image)--}}
{{--                        <img src="{{ asset('storage/'.$car->image) }}" class="w-32 h-20 object-cover rounded mb-2">--}}
{{--                    @endif--}}
